...
const get_lineGames_html = (game, page) => {
    const buttons = {
        'basket': `<button type="button" main_button data-button="del_basket" data-game_id="${game.id}" class="lineGames__game__right__buttons__button lineGames__game__right__buttons__button_red" title="Удалить из корзины" onclick="toggle_game_basket(${game.id}, '${game.name}'), update_basket_info()">
                        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M16 8L8 16M8.00001 8L16 16" stroke="#fff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                    </button>`,
        'favorite': `<button type="button" main_button data-button="del_favorite" data-game_id="${game.id}" class="lineGames__game__right__buttons__button lineGames__game__right__buttons__button_red" title="Удалить из избранного" onclick="toggle_game_favorite(${game.id}, '${game.name}'), update_favorite_games()">
                    ...
                    <button type="button" data-button="basket" data-game_id="${game.id}" class="lineGames__game__right__buttons__button lineGames__game__right__buttons__button_red" title="Туггл в корзину" onclick="toggle_game_basket(${game.id}, '${game.name}'), update_favorite_basket()">
